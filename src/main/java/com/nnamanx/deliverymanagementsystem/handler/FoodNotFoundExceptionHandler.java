...
public class FoodNotFoundExceptionHandler {
    @ExceptionHandler({FoodNotFoundException.class, FoodNotFoundException.class})
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ExceptionResponse handle() {
        return ExceptionResponse.builder()
                .message(ExceptionMessage.FOOD_NOT_FOUND_EXCEPTION.name())
