...
public class PasswordTokenNotFoundExceptionHandler {

    @ExceptionHandler({PasswordTokenNotFoundException.class, PasswordTokenNotFoundException.class})
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ExceptionResponse handle() {
        return ExceptionResponse.builder()
                .message(ExceptionMessage.PASSWORD_TOKE_NOT_FOUND_EXCEPTION.name())
